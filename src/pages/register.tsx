  ...
  return (
    <div className="flex grid-cols-2">
      <div className="w-1/2 bg-white">
        <div className="font-semibold font-robotoSlab text-[40px] ml-[65px] mt-8">
          Daftar
        </div>
        <div className="font-roboto text-[18px] ml-[65px]">
          Masukkan Email dan Password untuk Daftar
        </div>
        <button
          type="button"
        ...
        <button
          type="button"
          className="ml-[65px] mt-5 w-[505px] h-10 py-3 px-4 inline-flex justify-center items-center gap-x-2 rounded-lg border border-gray-200 bg-[#2A93D5] font-semibold font-roboto text-white text-[16px]"
        >
          Daftar
        </button>
