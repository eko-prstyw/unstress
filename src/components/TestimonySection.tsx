...
export default function TestimonySection() {
  return (
    <div className="w-full bg-[#f2f2f2] px-[100px] pt-16 pb-36  ">
      <h1 className="text-center text-7xl font-robotoSlab font-bold">
        Testimoni
      </h1>
      <p className="font-roboto text-lg text-center">
        Apa kata mereka tentang website kami
      </p>
        ...
        <div className="bg-white shadow-xl rounded-xl px-5 py-5">
          ...
          <div className="">
            ...
            <p className="font-robotoSlab text-base font-light">
              ""Saya merasa begitu terbantu oleh Fitur Chat Anonim di Unstress.
              Sebuah tempat yang aman untuk berbicara tentang stres saya tanpa
              perlu khawatir tentang privasi atau penilaian. hehehehehehe .”"
            </p>
          </div>
        </div>
        <div className="bg-white shadow-xl rounded-xl px-5 py-5">
